...
export WMII_NORMCOLORS='#aaaaaa #171616 #121111'
export WMII_FOCUSCOLORS='#ffffff #113659 #ffffff'

export WMII_BACKGROUND='#333333'
#export WMII_FONT='-*-fixed-medium-r-*-*-13-*-*-*-*-*-*-*'
export WMII_FONT='xos4-terminus-medium-r-normal-*-12-120-72-72-c-60-iso10646-1'
...
# Status Bar Info
status() {
    echo -n label $(uptime | sed 's/.*://; s/,//g') '|' $(sysstats -a)  '|' $(date +'%a %e %b %l:%M %p')
}
